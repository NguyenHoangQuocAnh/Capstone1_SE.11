...
async function getCustomer(req, res) {
  ...
  let sql = `select t1.*, t2.seat_status from Tickets t1 left join Seats t2 on t1.seat_number = t2.seat_number and t2.coach_id='Coach1'
...
async function getCustomerBoarded(req, res) {
  ...
  let countSql = `select count(t1.ticket_id) from Tickets t1 left join Seats t2 on t1.seat_number = t2.seat_number and t2.coach_id='Coach1'
